	   ...
	   case (PEvent.NETWORK_LAYER_READY):   
		...
		case (PEvent.FRAME_ARRIVAL ):
			...
			if (PFrame.KIND[r.kind].equals("DATA")){   
				...
				// start timer for ack to wait for a frame to piggyback 
				else
					start_ack_timer();
			
				// if seq between receiver's window, store incoming frame into the buffer
